...
namespace PROYECTO_FINAL_BD
{
    public partial class frmFacturaccion : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            txtApellido.Text = dgvClientes[2, poc1].Value.ToString() + " " + dgvClientes[3, poc].Value.ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    cmd = new SqlCommand("INSERT INTO Factura (cod_cliente,cod_camarote,cod_buque,cod_destino,cod_viaje,sub_total,descuento_adulto_mayor,isv,impuesto_portuario,propinas,total,descripcion) values ("+txtCodCliente.Text+","+txtCodCamarote.Text+","+txtCodBuque.Text+","+txtCodDestino.Text+","+txtCodViaje.Text+","+txtSubTotal.Text+","+txtTerceraEdad.Text+","+txtImpuesto.Text+","+txtImpProtuarios.Text+","+txtPropinas.Text+","+txtTotal.Text+",'"+txtItinerario.Text+"')",conect.sc);
                    cmd.ExecuteNonQuery();
